...
// Import utilities - use serverless version
const { connectDB } = require('./utils/database-serverless');
...
app.get('/api/v1/health', async (req, res) => {
  try {
    const { checkDBHealth } = require('./utils/database-serverless');
...
// Export the app without starting a server (for serverless)
module.exports = app;
