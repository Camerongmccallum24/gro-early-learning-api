  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95 transform",
  {
    variants: {
      variant: {
        ...
        gro: "bg-gro-orange text-white hover:bg-gro-orange/90 hover:shadow-lg hover:-translate-y-0.5",
        "gro-teal": "bg-gro-teal text-white hover:bg-gro-teal/90 hover:shadow-lg hover:-translate-y-0.5",
        "gro-green": "bg-gro-green text-white hover:bg-gro-green/90 hover:shadow-lg hover:-translate-y-0.5",
        "gro-darkblue": "bg-gro-darkblue text-white hover:bg-gro-darkblue/90 hover:shadow-lg hover:-translate-y-0.5",
      },
      size: {
