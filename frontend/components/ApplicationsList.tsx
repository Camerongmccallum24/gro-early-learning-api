...
export default function ApplicationsList() {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-xl font-bold text-gro-darkblue">Your Applications</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="text-center py-8">
          <FileText className="h-16 w-16 text-gro-gray mx-auto mb-4" />
          <h3 className="text-lg font-semibold text-gro-darkblue mb-2">
            No Applications Yet
          </h3>
          <p className="text-gro-gray mb-4">
            Start browsing our job opportunities and apply for positions that match your skills.
          </p>
          <Link href="/jobs">
            <Button className="bg-gro-orange hover:bg-gro-orange/90">
              Browse Jobs
